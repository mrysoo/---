У меня не получается сделать рабочими кнопки «Ввести расходы», «Ввести сбережения» и «Общая сумма на счете». При этом после запуска я могу ввести доходы, которые занесутся в базу данных и останутся там. 
